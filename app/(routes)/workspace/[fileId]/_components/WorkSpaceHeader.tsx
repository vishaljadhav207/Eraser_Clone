    ...
    return (
        <div className='p-3 border-b flex justify-between items-center'>
            ...
            <div className='flex items-center gap-4'>
                ...
                onClick={()=>onSave()}><Save className='h-4 w-3' />Save</Button>
                <Button className='h-8 text-[12px] gap-2 bg-blue-600 hover:bg-blue-700'>Share<Link className='h-4 w-3' /></Button>
            </div>
        </div>
    )
}
